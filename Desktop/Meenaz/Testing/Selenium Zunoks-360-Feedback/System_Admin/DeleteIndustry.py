...
class deleteIndustry(unittest.TestCase):
    def setUp(self):
        self.driver = webdriver.Chrome()

    def test_deleteIndustry(self):
        driver = self.driver
        try:
            ...
            try:
                ...
                delete = driver.find_element(
                    By.XPATH, "//*[@id='__next']/div[1]/main/div[2]/div[2]/div[2]/div/div[2]/div[2]/div/div/div/div[2]/div[3]/div/button[2]")
                delete.click()
                time.sleep(2)
                confirm = driver.find_element(
                    By.XPATH, "//*[@id='main']/div[2]/div[3]/div/div/div/div[2]/button[2]")
                confirm.click()
                # cancel = driver.find_element(By.XPATH, "//*[@id='main']/div[2]/div[3]/div/div/div/div[2]/button[1]")
                # cancel.click()
