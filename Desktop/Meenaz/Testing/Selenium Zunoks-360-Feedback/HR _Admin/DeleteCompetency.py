...
class deleteCompetency(unittest.TestCase):
    def setUp(self):
        self.driver = webdriver.Chrome()

    def test_deleteCompetency(self):
        driver = self.driver
        try:
            ...
            try:
                ...
                delete = driver.find_element(
                    By.XPATH, "//*[@id='__next']/div[1]/main/div[2]/div[2]/div[2]/div/div[2]/div[2]/div/div/div/div[2]/div[5]/div/button[2]")
                delete.click()
                time.sleep(2)
