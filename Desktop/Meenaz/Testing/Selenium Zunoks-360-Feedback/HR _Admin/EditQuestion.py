        ...
        try:
            ...
            try:
                ...
                dropdown = driver.find_element(
                    By.CSS_SELECTOR, "#panel1bh-header > div.MuiAccordionSummary-expandIconWrapper.css-1fx8m19")
                dropdown.click()
                time.sleep(2)
                edit2 = driver.find_element(
                    By.XPATH, "//*[@id='panel1bh-content']/div/div/div[1]/div[3]/button[2]")
                edit2.click()
                time.sleep(2)
                ...
                time.sleep(1)
                clear = driver.find_element(
                    By.XPATH, "//*[@id='main']/div[2]/div[3]/div/div/div/div/form/div/div[3]/div[2]/div/div/div/div/div/button[1]")
                clear.click()
                time.sleep(2)
                action.send_keys(Keys.ARROW_DOWN).send_keys(Keys.ARROW_DOWN).send_keys(
                    Keys.ENTER).perform()
                time.sleep(2)
