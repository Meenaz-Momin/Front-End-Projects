    ...
    def test_deleteEmployee(self):
        ...
        try:
            ...
            try:
                ...
                file.write(
                    "\nDelete Questionnaire: Fail\t Date:")
                ...
                time.sleep(2)
                my_questionnaire = driver.find_element(
                    By.XPATH, "//*[@id='__next']/div[1]/main/div[2]/div[2]/div[1]")
                my_questionnaire.click()
                time.sleep(2)
                ...
                if(rows == 0):
                    file = open("Manager_Report.txt", "a")
                    file.write(
                        "\Edit Questionnaire: No List\t Date:")
                    file.write(dt_string)
                    file.close()
                else:
                    ...
                    edit.click()
                    time.sleep(2)
                    competency = driver.find_element(
                        By.XPATH, "//*[@id='__next']/div[1]/main/div[2]/div[2]/div[1]/div/button[2]")
                    competency.click()
                    time.sleep(2)
                    add_competency = driver.find_element(
                        By.XPATH, "//*[@id='__next']/div[1]/main/div[2]/div[2]/div[2]/form/div/div/div[2]/div/div/div/div[1]/div[2]/button[1]")
                    add_competency.click()
                    time.sleep(2)
                    checkbox1 = driver.find_element(
                        By.XPATH, "//*[@id='main']/div[2]/div[3]/div/div/div/div/div/div/div/div[2]/div/div[2]/div[2]/div/div/div/div[2]/div[1]/span/input")
                    checkbox1.click()
                    time.sleep(2)
                    cross = driver.find_element(
                        By.XPATH, "//*[@id=': r1u: ']/button")
                    cross.click()
                    time.sleep(2)
                    next = driver.find_element(
                        By.XPATH, "//*[@id='__next']/div[1]/main/div[2]/div[2]/div[2]/form/div/div/div[2]/div/div/div/div[1]/div[2]/button[2]")
                    next.click()
                    time.sleep(2)
                    add_question = driver.find_element(
                        By.XPATH, "//*[@id='__next']/div[1]/main/div[2]/div[2]/div[2]/form/div/div/div[2]/div/div/div[2]/div/div[2]/div[2]/div/div/div/div[4]/div[5]/div/button[1]")
                    add_question.click()
                    time.sleep(2)
                    ...
                    update = driver.find_element(
                        By.XPATH, "//*[@id='__next']/div[1]/main/div[2]/div[2]/div[2]/form/div/div/div[2]/div/div/div[1]/div[2]/button[2]")
                    update.click()
                    time.sleep(2)
