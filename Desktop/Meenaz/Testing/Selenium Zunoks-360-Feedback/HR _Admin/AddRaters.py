...
class addRaters(unittest.TestCase):
    def setUp(self):
        self.driver = webdriver.Chrome()

    def test_addRaters(self):
        driver = self.driver
        try:
            ...
            try:
                ...
                new.click()
                time.sleep(1)
                category_name = driver.find_element(By.NAME, "category_name")
                ...
                category_name.send_keys(RATERS)
