...
valid_password = "1234"
invalid_mail = "channel.partner123@apsis.com"
invalid_password = "12345"


class LOGIN_ADMIN(unittest.TestCase):
    ...
    def tearDownClass(self):
        ...
        #     subject = "HRMS-360 System Admin: Login Functionality"
...
def suite():
    ...
    suite.addTest(LOGIN_ADMIN("test_invalidEmail"))
    suite.addTest(LOGIN_ADMIN("test_invalidPassword"))
    suite.addTest(LOGIN_ADMIN("test_blankField"))
    suite.addTest(LOGIN_ADMIN("test_enterkey"))
    suite.addTest(LOGIN_ADMIN("test_validCredential"))
    return suite
