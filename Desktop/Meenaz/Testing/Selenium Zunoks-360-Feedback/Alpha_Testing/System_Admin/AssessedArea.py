...
class ASSESSMENTAREA_ADMIN(unittest.TestCase):
    @classmethod
    def setUpClass(self):
        ...
        setting.click()
        time.sleep(1)
        assessmentArea = WebDriverWait(driver, 10).until(EC.presence_of_element_located(
            (By.XPATH, "//*[@id='__next']/div[1]/nav/div/div/div/ul/div/div/div/div/div/li[2]")))
        assessmentArea.click()
        time.sleep(2)
    ...
    def test_blankTitle(self):
        ...
        try:
            ...
            newArea = WebDriverWait(driver, 10).until(EC.presence_of_element_located(
            ...
            if(rows+1 == rows2):
                body.append(
                    f"Blank Field in Assessment Area: Fail    {dt_string}")
                print(body)
                assert False
            else:
                ...
                time.sleep(2)
                body.append(
                    f"Blank Field in Assessment Area: Pass    {dt_string}")
                assert True
    ...
    def test_255Title(self):
        ...
        try:
            ...
            if(rows+1 == rows2):
                body.append(
                    f"255 Character in Assessment Area Title: Pass    {dt_string}")
                assert True
            else:
                cancel = driver.find_element(
                    By.XPATH, "/html[1]/body[1]/div[2]/div[3]/div[1]/div[1]/div[1]/h2[1]/button[1]"
                ...
                time.sleep(2)
                body.append(
                    f"255 Character in Assessment Area Title: Fail    {dt_string}")
                assert False
    ...
    def test_256Title(self):
        ...
        try:
            ...
            if(rows+1 == rows2):
                body.append(
                    f"256 Character in Assessment Area Field: Fail    {dt_string}")
                assert False
            else:
                cancel = driver.find_element(
                    By.XPATH, "/html[1]/body[1]/div[2]/div[3]/div[1]/div[1]/div[1]/h2[1]/button[1]"
                ...
                time.sleep(2)
                body.append(
                    f"256 Character in Assessment Area Field: Pass    {dt_string}")
                assert True
    ...
    def test_switchOff(self):
        ...
        try:
            ...
            if(rows+1 == rows2):
                body.append(
                    f"is_Active Switch Off in Assessment Area: Pass    {dt_string}")
                assert True
            else:
                try:
                    cancel = driver.find_element(
                    ...
                    time.sleep(2)
                    body.append(
                        f"is_Active Switch Off in Assessment Area: Fail    {dt_string}")
                    assert False
                except:
                    time.sleep(2)
                    body.append(
    ...
    def tearDownClass(self):
        ...
        #     subject = "HRMS-360 System Admin:Setting Configuration/Area Assesssed"
...
def suite():
    ...
    suite.addTest(ASSESSMENTAREA_ADMIN("test_blankTitle"))
    suite.addTest(ASSESSMENTAREA_ADMIN("test_255Title"))
    suite.addTest(ASSESSMENTAREA_ADMIN("test_256Title"))
    suite.addTest(ASSESSMENTAREA_ADMIN("test_switchOff"))
    return suite
