...
class INDUSTRY(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        setting.click()
        time.sleep(1)
        industry = WebDriverWait(driver, 10).until(EC.presence_of_element_located(
    ...
    def test_blankTitle(self):
        ...
        try:
            ...
            newDepartment = WebDriverWait(driver, 10).until(EC.presence_of_element_located(
            ...
            if(rows+1 == rows2):
                body.append(
                    f"Blank Field in INDUSTRY: Fail    {dt_string}")
                print(body)
                assert False
            else:
                ...
                time.sleep(2)
                body.append(
                    f"Blank Field in INDUSTRY: Pass    {dt_string}")
                assert True
    ...
    def test_255Title(self):
        ...
        try:
            ...
            if(rows+1 == rows2):
                body.append(
                    f"255 Character in INDUSTRY Name: Pass    {dt_string}")
                assert True
            else:
                cancel = driver.find_element(
                    By.XPATH, "/html[1]/body[1]/div[2]/div[3]/div[1]/div[1]/div[1]/h2[1]/button[1]"
                ...
                time.sleep(2)
                body.append(
                    f"255 Character in INDUSTRY Name: Fail    {dt_string}")
                assert False
    ...
    def test_256Title(self):
        ...
        try:
            ...
            if(rows+1 == rows2):
                body.append(
                    f"256 Character in INDUSTRY Name: Fail    {dt_string}")
                assert False
            else:
                cancel = driver.find_element(
                    By.XPATH, "/html[1]/body[1]/div[2]/div[3]/div[1]/div[1]/div[1]/h2[1]/button[1]"
                ...
                time.sleep(2)
                body.append(
                    f"256 Character in INDUSTRY Name: Pass    {dt_string}")
                assert True
    ...
    def test_switchOff(self):
        ...
        try:
            ...
            if(rows+1 == rows2):
                body.append(
                    f"is_Active Switch Off in INDUSTRY: Pass    {dt_string}")
                assert True
            else:
                try:
                    cancel = driver.find_element(
                    ...
                    time.sleep(2)
                    body.append(
                        f"is_Active Switch Off in INDUSTRY: Fail    {dt_string}")
                    assert False
                except:
                    time.sleep(2)
                    body.append(
    ...
    def tearDownClass(self):
        ...
        #     subject = "HRMS-360 System Admin:Setting/Industry"
...
def suite():
    ...
    suite.addTest(INDUSTRY("test_blankTitle"))
    suite.addTest(INDUSTRY("test_255Title"))
    suite.addTest(INDUSTRY("test_256Title"))
    suite.addTest(INDUSTRY("test_switchOff"))
    return suite
