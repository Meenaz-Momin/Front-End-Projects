...
class QUESTIONS(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        time.sleep(2)
        my_competency = WebDriverWait(driver, 10).until(EC.presence_of_element_located(
...
def suite():
    ...
    suite.addTest(QUESTIONS("test_blankQuestion"))
    suite.addTest(QUESTIONS("test_255Question"))
    suite.addTest(QUESTIONS("test_256Question"))
    suite.addTest(QUESTIONS("test_blankAssessment"))
    suite.addTest(QUESTIONS("test_allAssessment"))
    suite.addTest(QUESTIONS("test_blankResponseType"))
    suite.addTest(QUESTIONS("test_textResponse"))
    suite.addTest(QUESTIONS("test_yes_noResponse"))
    suite.addTest(QUESTIONS("test_MCQResponse"))
    suite.addTest(QUESTIONS("test_MultipleMCQResponse"))
    suite.addTest(QUESTIONS("test_LikertResponse"))
    return suite
