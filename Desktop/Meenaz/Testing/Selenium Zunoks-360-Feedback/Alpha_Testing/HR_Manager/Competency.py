...
class COMPETENCY(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        time.sleep(1)
        add_competency = WebDriverWait(driver, 10).until(EC.presence_of_element_located(
    ...
    def test_BothBlankField(self):
        ...
        try:
            ...
            driver.get("http://192.168.10.60:3000/competency-bank/add")
            title = WebDriverWait(driver, 10).until(
                EC.presence_of_element_located((By.NAME, "title")))
    ...
    def test_titleMoreThan255(self):
        driver = self.driver
        try:
            title = WebDriverWait(driver, 10).until(
                EC.presence_of_element_located((By.NAME, "title")))
    ...
    def test_descriptionMoreThan255(self):
        driver = self.driver
        try:
            title = WebDriverWait(driver, 10).until(
                EC.presence_of_element_located((By.NAME, "title")))
...
def suite():
    ...
    suite.addTest(COMPETENCY("test_BothBlankField"))
    suite.addTest(COMPETENCY("test_BlankTitle"))
    suite.addTest(COMPETENCY("test_BlankDescription"))
    suite.addTest(COMPETENCY("test_titleMoreThan255"))
    suite.addTest(COMPETENCY("test_descriptionMoreThan255"))
    suite.addTest(COMPETENCY("test_title255"))
    suite.addTest(COMPETENCY("test_description255"))
    return suite
