...
class DEPARTMENT(unittest.TestCase):
    ...
    def test_blankTitle(self):
        ...
        try:
            ...
            if(rows+1 == rows2):
                body.append(
                    f"Blank Field in Department: Fail    {dt_string}")
                print(body)
                assert False
            else:
                ...
                time.sleep(2)
                body.append(
                    f"Blank Field in Department: Pass    {dt_string}")
                assert True
    ...
    def test_255Title(self):
        ...
        try:
            ...
            if(rows+1 == rows2):
                body.append(
                    f"255 Character in Department Name: Pass    {dt_string}")
                assert True
            else:
                cancel = driver.find_element(
                    By.XPATH, "/html[1]/body[1]/div[2]/div[3]/div[1]/div[1]/div[1]/h2[1]/button[1]"
                ...
                time.sleep(2)
                body.append(
                    f"255 Character in Department Name: Fail    {dt_string}")
                assert False
    ...
    def test_256Title(self):
        ...
        try:
            ...
            if(rows+1 == rows2):
                body.append(
                    f"256 Character in Department Name: Fail    {dt_string}")
                assert False
            else:
                cancel = driver.find_element(
                    By.XPATH, "/html[1]/body[1]/div[2]/div[3]/div[1]/div[1]/div[1]/h2[1]/button[1]"
                ...
                time.sleep(2)
                body.append(
                    f"256 Character in Department Name: Pass    {dt_string}")
                assert True
    ...
    def test_switchOff(self):
        ...
        try:
            ...
            if(rows+1 == rows2):
                body.append(
                    f"is_Active Switch Off in Department: Pass    {dt_string}")
                assert False
            else:
                try:
                    cancel = driver.find_element(
                    ...
                    time.sleep(2)
                    body.append(
                        f"is_Active Switch Off in Department: Fail    {dt_string}")
                    assert True
                except:
                    time.sleep(2)
                    body.append(
...
def suite():
    ...
    suite.addTest(DEPARTMENT("test_blankTitle"))
    suite.addTest(DEPARTMENT("test_255Title"))
    suite.addTest(DEPARTMENT("test_256Title"))
    suite.addTest(DEPARTMENT("test_switchOff"))
    return suite
