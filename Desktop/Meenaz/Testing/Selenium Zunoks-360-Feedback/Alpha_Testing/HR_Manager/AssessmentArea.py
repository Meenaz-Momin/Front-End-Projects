...
class ASSESSMENTAREA(unittest.TestCase):
    @classmethod
    def setUpClass(self):
...
def suite():
    ...
    suite.addTest(ASSESSMENTAREA("test_blankTitle"))
    suite.addTest(ASSESSMENTAREA("test_255Title"))
    suite.addTest(ASSESSMENTAREA("test_256Title"))
    suite.addTest(ASSESSMENTAREA("test_switchOff"))
    return suite
